...
struct f2fs_nm_info {
	...
	char *nat_flip_bitmap;
	int nat_flip_bitmap_size;
...
struct dnode_of_data { /* different from dnode_of_data in kernel */
       struct f2fs_node *inode_page; /* inode page */
       struct f2fs_node *node_page; /* cached direct node page */
       nid_t nid;
